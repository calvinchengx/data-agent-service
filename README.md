...
| **Nothing here is claimed without something that checks it** | Every capability carries a command that proves it; where something is designed but not built, the docs say so | 141 end-to-end witnesses, in CI on every push |
