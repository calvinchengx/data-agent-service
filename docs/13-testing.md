...
ranking. That is why the badges publish a witness count next to the
...
answer — and no statement counter scores any of that. A count of witnesses, all passing, is a
